...
class Reactor_Core():
    def __init__(self,TemperatureFuel:list,TemperatureModerator:list,Power:float,Precursor:float,Pressure:float,Temp_hotleg:float
        ...
        #volumes 
        self.CoolantVcore=(self.fuel_pitch**2-np.pi*self.df**2/4)*self.active_height*self.N_rods # aikhane bvvhul ache 
        self.area=np.pi*self.df*self.active_height*self.N_fue_rods

        self.FuelMass=np.pi*(self.df-2*self.gas_gap)**2*self.active_height*self.N_fue_rods*self.rho_f/4
        self.Wc=1889.68208
        ...
        self.Mcl=((self.piping_length-self.core_height)*self.RCP_position_factor*np.pi*self.pipe_diameter**2/4)*PropsSI("D","P",self.Pressure,"Q",0,'water')
        ...
        self.Mhl=((self.piping_length-self.core_height)*(1-self.RCP_position_factor)*np.pi*self.pipe_diameter**2/4)*PropsSI("D","P",self.Pressure,"Q",0,'water')
        ...
        self.Lamda=self.total_delayed_const/(self.Beta1/self.Lamda1+self.Beta2/self.Lamda2+self.Beta3/self.Lamda3+self.Beta4/self.Lamda4+self.Beta5/self.Lamda5+self.Beta6/self.Lamda6)
    ...
    def Reactivity(self,FuelTempSum:float,ModeratorTempSum):        
        self.reactivity=self.ExternalReactivity+self.Alpha_f*(self.tempfuel-FuelTempSum)/5+self.Alpha_m*(self.tempmod-ModeratorTempSum)/10
    ...
    '''###########################################################################################'''    
    def DTf1(self):
        dtdTf1=self.Fr*self.NominalPower*self.PowerRatio/(self.Mf*self.Cpf)+self.U*self.area*(self.Tmo1-self.Tf1)/(self.Mf*self.Cpf)
        return dtdTf1
    ...
    def DTf3(self):
        dtdTf3=self.Fr*self.NominalPower*self.PowerRatio/(self.Mf*self.Cpf)+self.U*self.area*(self.Tmo5-self.Tf3)/(self.Mf*self.Cpf)
        return dtdTf3
    
    def DTf4(self):
        dtdTf2=self.Fr*self.NominalPower*self.PowerRatio/(self.Mf*self.Cpf)+self.U*self.area*(self.Tmo7-self.Tf4)/(self.Mf*self.Cpf)
        return dtdTf2
        
    def DTf5(self):
        dtdTf3=self.Fr*self.NominalPower*self.PowerRatio/(self.Mf*self.Cpf)+self.U*self.area*(self.Tmo9-self.Tf5)/(self.Mf*self.Cpf)
        return dtdTf3
    '''###########################################################################################'''
    '''                                     MODERATOR REGION                                      '''
    '''###########################################################################################'''
    ...
    def DTmo1(self):
        ...
        b=self.U*self.area*(self.Tf1-self.Tmo1)/(self.Mmo*self.Cpc)+(self.Tlp-self.Tmo1)/self.time_constmo
        dtdTm01=a+b
        return dtdTm01 
    ...
    def DTmo4(self):
        self.time_constmo=self.Mmo/(self.Wc*2)
        a=(1-self.Fr)*self.NominalPower*self.PowerRatio/(self.Mmo*self.Cpc)
        b=self.U*self.area*(self.Tf2-self.Tmo3)/(self.Mmo*self.Cpc)+(self.Tmo3-self.Tmo4)/self.time_constmo
        dtdTm04=a+b
        return dtdTm04
    ...
    def DTmo5(self):
        self.time_constmo=self.Mmo/(self.Wc*2)
        a=(1-self.Fr)*self.NominalPower*self.PowerRatio/(self.Mmo*self.Cpc)
        b=self.U*self.area*(self.Tf3-self.Tmo5)/(self.Mmo*self.Cpc)+(self.Tmo4-self.Tmo5)/self.time_constmo
        dtdTm05=a+b
        return dtdTm05
    ...
    def DTmo6(self):
        ...
        self.time_constmo=self.Mmo/(self.Wc*2)
        a=(1-self.Fr)*self.NominalPower*self.PowerRatio/(self.Mmo*self.Cpc)
        b=self.U*self.area*(self.Tf3-self.Tmo5)/(self.Mmo*self.Cpc)+(self.Tmo5-self.Tmo6)/self.time_constmo
    ...
    def DTmo7(self):
        ...
        self.time_constmo=self.Mmo/(self.Wc*2)
        a=(1-self.Fr)*self.NominalPower*self.PowerRatio/(self.Mmo*self.Cpc)
        b=(self.Tmo6-self.Tmo7)/self.time_constmo+self.U*self.area*(self.Tf4-self.Tmo7)/(self.Mmo*self.Cpc)
        dtdTm03=a+b      
        return dtdTm03
    ...
    def DTmo10(self):
        self.time_constmo=self.Mmo/(self.Wc*2)
        a=(1-self.Fr)*self.NominalPower*self.PowerRatio/(self.Mmo*self.Cpc)
        b=self.U*self.area*(self.Tf5-self.Tmo9)/(self.Mmo*self.Cpc)+(self.Tmo9-self.Tmo10)/self.time_constmo
        dtdTm06=a+b
        return dtdTm06
    ...
    def DTup(self):
        self.Mup=((self.core_height-self.active_height)*self.d**2*PropsSI("D","P",self.Pressure,"Q",0,'water'))*(1-self.core_center_factor)/4
